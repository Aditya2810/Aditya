...
PROC IMPORT DATAFILE= '/home/cxk1714300/sasuser.v94/ads demo3.csv' OUT=DEMOGRAPHICS DBMS=CSV;
RUN;

DATA PANELSCANNER;
INFILE "/home/cxk1714300/sasuser.v94/hhclean_PANEL_GR_1114_1165.dat" FIRSTOBS =2 dlm="09"x;
INPUT PANID WEEK UNITS OUTLET $ DOLLARS IRI_KEY COLUPC;
RUN;

DATA STOREINFO;
INFILE "/home/cxk1714300/sasuser.v94/Delivery_Stores" FIRSTOBS =2;
INPUT IRI_KEY 1-8 OU $ 9-10  EST_ACV 12-19 Market_Name $ 21-44  Open 46-49 Clsd 51-54 MskdName $  56-63  ;
RUN;

DATA SCANNERGROC;
INFILE "/home/cxk1714300/sasuser.v94/hhclean_groc_1114_1165" FIRSTOBS =2;
INPUT IRI_KEY 1-7 WEEK 9-12 SY 14-15 GE 17-18 VEND 20-24  ITEM 26-30  UNITS 32-36 DOLLARS 38-45 F $ 46-50 D 52 PR 54 ;
RUN;

PROC IMPORT DATAFILE= '/home/cxk1714300/sasuser.v94/IRI_week.xls' OUT=IRIWEEK DBMS=XLS;
RUN;

PROC IMPORT DATAFILE= '/home/cxk1714300/sasuser.v94/prod_hhclean.xls' OUT=work.Product DBMS=XLS;
RUN;
